...
## COMO LEVANTAR EL PROYECTO
    ...
    - Ejecutar el script 'Cinf.sh' para crear el entorno en caso de que no este creado.
    - Activar el entorno virtual .venv e instalar todas las dependencias necesarias.
